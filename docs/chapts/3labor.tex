...
This formulation has two main advantages. First, expressing labour supply in hours captures changes in work intensity that are missed by measures based solely on population size or labour-force counts. Second, using participation rates rather than employment alone includes both employed and unemployed individuals who remain attached to the labour market. The approach relies on the assumption that unemployed individuals are willing and able to work the same average annual hours as employed individuals of the same age group and birthplace status. While this assumption is reasonable for the purpose of demographic decomposition and accounting, it is not trivial from an economic perspective, especially in the Spanish context, where long-term unemployment and skill mismatch are structural features of the labour market. Consequently, the estimate derived from equation~\eqref{eq:pclab} should be interpreted as a measure of potential labour supply, not as a welfare-relevant or market-clearing concept. Table~\ref{tab:labSum} summarises the size of the population aged 16 and over and the corresponding aggregate labour supply in 2005 and 2025.
